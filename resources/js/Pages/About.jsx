    ...
    return (
        <MainLayout title="About me">
            <div className="flex flex-1 flex-col ">
                <div className="grid h-full grid-rows-[1fr_2fr] gap-4 sm:grid-rows-[1fr_1fr] md:gap-24 lg:grid-cols-[1fr_2fr] lg:grid-rows-1 ">
                    ...
                    <div className="flex flex-col gap-4 md:gap-8">
                        ...
                        <div className="blog-styles max-w-[800px] space-y-4 md:space-y-8">
                            <p>
                                ...
                                always eager to learn. I play the piano and
                                flute, and have contributed to orchestral bands
                                and choirs.
                            </p>
                            <p>
                                Programming has been my favorite activity since
                                I was 10, starting with Scratch and progressing
                                to Python, C#, PHP, JavaScript, and Kotlin. My
                                relentless pursuit of excellence drives my
                                success.
                            </p>
                        </div>
